...
// --- THE FIX IS HERE ---
// Preload your custom model
useGLTF.preload('/models/pratik_card.glb')
useTexture.preload('/band.png')

// This component is the 2D content that gets projected onto the 3D card
...
// This component contains the physics and 3D models for the card and lanyard
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const { nodes, materials } = useGLTF('/models/pratik_card.glb')
      ...
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            {/* We no longer need to project HTML, so this part is removed */}
...
// This is the main export. It sets up the entire 3D scene.
